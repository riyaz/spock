 ...
 *     {@link spock.util.function.Function} (unary function from {@code T} to {@code R}),
 *     {@link spock.util.function.Consumer} (unary function from {@code T} to {@code void}),
 *     {@link spock.util.function.Predicate} (unary function from {@code T} to {@code boolean}),
 *     and {@link spock.util.function.Supplier} (nilary function to {@code R}).
 *     </li>
 *
 * </ul>
 *
 */
package spock.util.function;
